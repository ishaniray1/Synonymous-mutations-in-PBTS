# output directory
dir.create("filter_combinations_2_output", showWarnings = FALSE)
...
# all filter combinations (2^4 = 16 combinations)
...
comparison_df_2
write_csv(comparison_df_2, "filter_combinations_output/comparison_summary.csv")

print(comparison_df_2)

# comparison barplot
comparison_plot_2 <- comparison_df_2 %>%
...
ggsave("filter_combinations_output/filter_comparison_plot.png", 
       comparison_plot_2, width = 12, height = 10, dpi = 300)

ggsave("filter_combinations_output/filter_comparison_plot.pdf", 
       comparison_plot_2, width = 12, height = 10)
